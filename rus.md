...
размещением агата в соответствии с основным текстом. В общем, над всем этим еще
нужно работать.
...
и подсказки-агаты — главные приоритеты, сформулированные на [семинаре по созданию

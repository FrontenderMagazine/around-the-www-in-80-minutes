...
![Подсказки рубин над идеографическим текстом][«рубин»]

*Подсказки «рубин» над идеографическим текстом*

Паспарту продолжил рассказывать о том, что хоть рубин уже и применяется в сети,
...
которые предоставляют патчи. И кстати, спецификация по CSS-стилизации рубина
также нуждается в доработке. Это сделает возможным достаточный контроль над
размещением рубина в соответствии с основным текстом. В общем, над всем этим еще
нужно работать.
...
и подсказки-рубины — главные приоритеты, сформулированные на [семинаре по созданию
...
<ol start="3">
  <li>В которой Филеас Фогг и паспарту знакомятся с полями форм на Суматре.</li>
  <li>В которой Паспарту ошарашивает Филеаса Фогга новостями о том, как
    выглядит текст на бирманском языке.</li>
  <li>В которой Филеас Фогг изучает письмена индусов.</li>
  <li>В которой Филеас Фогг не может определиться прибывает он или отбывает.</li>
  <li>Из которой мы узнаём, что произошло во время путешествия по европе.</li>
  <li>В которой доказывается, что Филеас Фогг, совершив кругосветное
    путешествие много выиграл, но это ещё не конец.</li>
</ol>
